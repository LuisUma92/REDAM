...
%\coordinate (o) at (0,0);
	...
	\begin{abstractclass}[text width = 9.5 cm]{Pastilla}{10,0}
		...
		\operation[0]{+ setPath() : void}
		\operation[0]{+ setPastilla() : void}
	...
	\begin{class}[text width = 8 cm]{TFR}{5,-7}
		...
		\attribute{- cols : int}
		%-------------------------------------------------%		
		\operation{+ setPath(tfr\_name : string) : void}
		\operation{+ setPastilla(tfr\_name : string) : void}
	...
	\begin{class}[text width = 8 cm]{MCA}{15,-7}
		...
		%-------------------------------------------------%		
		\operation{+ setPath(mca\_name : string) : void}
		\operation{+ setPastilla(mca\_name : string) : void}
		\operation{+ getFull() : string}
